...
export const metadata = {
  ...
  description:
    "Reusable App Store and Google Play policy guidance mapped across the 48 validated app ideas.",
};
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-10 px-4 py-8 md:py-12">
        ...
        <section className="rounded-3xl border border-zinc-800 bg-zinc-950/50 p-6 md:p-8">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-zinc-400 md:text-lg">
            This guide turns the app store research into a reusable launch layer for all 48 validated ideas. Each idea is scored into a low, review, or high policy bucket and tagged with the policy families most likely to matter.
          </p>
