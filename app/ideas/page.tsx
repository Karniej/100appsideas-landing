...
export const metadata = {
  title: "68 Validated App Ideas Browser",
  description: "Browse all 68 Astro-verified app ideas with filters, search, detailed breakdowns, and Codex-ready build prompts.",
};
