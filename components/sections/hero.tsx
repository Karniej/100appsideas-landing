      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-medium bg-amber-500/10 text-amber-500 border border-amber-500/20">
              ...
              265 qualified keywords screened &mdash; re-validated 2026-05-11
            </span>
          </motion.div>
          ...
          >
            ...
            {" "}MCP API. 265 qualified keywords screened, then 486 list keywords audited in one Astro app. 31 ideas remain active after stale data was demoted.
            Real volume, chance, difficulty, search saturation, search intent, competitors, and review counts &mdash; not vibes. Last validated 2026-05-13.
          </motion.p>
        ...
        >
          <div className="p-6 rounded-xl bg-zinc-900/50 border border-zinc-800 text-center">
            ...
            <div className="text-3xl font-heading font-bold mb-1">265</div>
          ...
          <div className="p-6 rounded-xl bg-zinc-900/50 border border-zinc-800 text-center">
            ...
            <div className="text-3xl font-heading font-bold mb-1">Vague</div>
            <p className="text-sm text-zinc-400">
              Brand and fuzzy-intent keywords rejected
            </p>
          </div>
        </motion.div>
      </div>
