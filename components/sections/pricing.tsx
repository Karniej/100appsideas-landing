...
const features = [
  { icon: FileText, text: "68 validated app ideas with full write-ups" },
  ...
  { icon: ListOrdered, text: "All 68 ranked by pop/diff ratio (best opportunity first)" },
  {
    icon: Check,
          ...
          <div className="relative">
            <div className="mb-8">
              ...
              <p className="text-zinc-300">
                The complete 68 Validated App Ideas research document, plus everything
            ...
            <p className="text-center text-xs text-zinc-500 mt-4">
              Includes the boilerplate, 68 Validated App Ideas, Discord community, and
              lifetime updates.
            </p>
          </div>
        </motion.div>
